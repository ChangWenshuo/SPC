...
infile <- file.path(OutPath,'SPF_rating_data.txt')
...
file.g <- file.path(OutPath,'SPF_rating_stanmodel_group.txt')
file.s <- file.path(OutPath,'SPF_rating_stanmodel_subject.txt')
...
ggsave(file.path(OutPath,'SPF_rating_stanmodel.png'),plot=pp,width=7,height=5.5)
ggsave(file.path(OutPath,'SPF_rating_stanmodel.pdf'),plot=pp,width=7,height=5.5)
